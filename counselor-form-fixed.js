/**
 * Afya Yako Complete Counselor Onboarding Form - FIXED - June 20, 2026
...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
      injectCounselorFormFixed();
    }, 500);
  });

  function injectCounselorFormFixed() {
    const formContainer = document.querySelector('form, [role="form"]');
    if (!formContainer) {
      console.log('Form container not found, retrying...');
      setTimeout(injectCounselorFormFixed, 1000);
      return;
    }

    if (document.getElementById('counselor-form-fixed')) {
    ...
    form.innerHTML = `
      ...
      <div class="card space-y-3">
        ...
        <select id="specializations" name="specializations" multiple class="w-full p-2 border border-gray-300 rounded-lg" size="6">
          ...
          <option value="substance_abuse">Substance Abuse & Addiction</option>
          <option value="family">Family Therapy</option>
          <option value="grief">Grief & Loss</option>
          <option value="eating_disorders">Eating Disorders</option>
          <option value="ocd">OCD & Anxiety Disorders</option>
          <option value="lgbtq">LGBTQ+ Affirming Therapy</option>
          <option value="parenting">Parenting & Child Issues</option>
          <option value="other">Other (specify below)</option>
        </select>

        <div class="bg-blue-50 border border-blue-200 rounded p-2 text-xs text-blue-700">
          💡 Tip: Hold Ctrl/Cmd and click to select multiple options
        </div>
      ...
      <div class="card space-y-3">
        ...
        <select id="languages" name="languages" multiple class="w-full p-2 border border-gray-300 rounded-lg" size="5">
  ...
  window.AfyaYakoCounselorFormFixed = {
    injectCounselorFormFixed,
  };
